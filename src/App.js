    ...
    return (
      <div className="App">
        ...
        <div id="seguimiento-donativos">
          ...
          <p>
            Empresas, organizaciones y países han mostrado su solidaridad con
            México al anunciar donativos para ayudar a nuestro país tras los
            sismos del 7S y 19S.
          </p>
          <p>
            Para poder darle seguimiento a esta ayuda, queremos recopilar los
            anuncios públicos sobre dichas donaciones.
          </p>

          <p className="ListaDonadores-intro">
            Ya empezamos una lista pero <strong>necesitamos tu ayuda.</strong>{" "}
            Si tienes información adicional escribe un mensaje en el{" "}
            <strong>
              <a
          ...
          <p className="ListaDonadores-intro">
            Si tienes dudas, sugerencías o comentariós te invitamos a hacerlos
            haciendo un Issue en el{" "}
            <strong>
              <a
          ...
          <p className="ListaDonadores-intro">
            Todos los donativos suman. Puedes contribuir registrando tu donativo
            en: {" "}
            <strong>
              <a
